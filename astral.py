...
class CivilTwilight:
    ...
    def get_timestamp(self, time: ephem.Date):
    ...
    def calculate(self, lat: str, lon: str):
        ...
        return {
            "twilight_start": self.get_timestamp(twilight_start),
            "twilight_end": self.get_timestamp(twilight_end)
        }
...
def main():
    ...
    location = {"name": "Lincoln", "lat": "53.22903220860873", "long": "-0.5375311145327252"}
